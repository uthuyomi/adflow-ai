...
DEFAULT_AGENTS: tuple[AgentProfile, ...] = (
    ...
    AgentProfile(
        agent_key="evidence_collector",
        display_name="Evidence Collector",
        provider="mock",
        role="evidence_collection",
        strengths=("source collection", "normalization", "research corpus setup"),
        default_tasks=("evidence_collection", "source_normalization"),
    ),
    AgentProfile(
        agent_key="evidence_clusterer",
        display_name="Evidence Clusterer",
        provider="openai",
        role="evidence_clustering",
        strengths=("pain clustering", "intent clustering", "competitor clustering"),
        default_tasks=("pain_clustering", "intent_clustering", "competitor_clustering"),
    ),
    AgentProfile(
        agent_key="product_reviewer",
        display_name="Product Reviewer",
        provider="openai",
        role="product_review",
        strengths=("product review", "opportunity scoring", "roadmap generation"),
        default_tasks=("product_review", "opportunity_scoring", "roadmap_generation"),
    ),
    AgentProfile(
        agent_key="backlog_planner",
        display_name="Backlog Planner",
        provider="openai",
        role="backlog_planning",
        strengths=("backlog prioritization", "Codex task candidate generation"),
        default_tasks=("backlog_prioritization", "codex_task_candidate_generation"),
    ),
    AgentProfile(
        agent_key="roadmap_planner",
        display_name="Roadmap Planner",
        provider="openai",
        role="roadmap_planning",
        strengths=("now next later planning", "evidence-based sequencing", "do-not-build guardrails"),
        default_tasks=("roadmap_generation", "roadmap_prioritization"),
    ),
    AgentProfile(
        agent_key="monitoring_analyst",
        display_name="Monitoring Analyst",
        provider="openai",
        role="monitoring_analysis",
        strengths=("trend alerting", "competitor change detection", "pain spike analysis"),
        default_tasks=("trend_monitoring", "alert_generation"),
    ),
    AgentProfile(
        agent_key="learning_analyst",
        display_name="Learning Analyst",
        provider="openai",
        role="learning_analysis",
        strengths=("outcome pattern analysis", "recommendation biasing", "closed-loop learning"),
        default_tasks=("learning_pattern_detection", "outcome_biasing"),
    ),
    AgentProfile(
        agent_key="idea_parser",
        display_name="Idea Parser",
        provider="mock",
        role="idea_parsing",
        strengths=("conversation parsing", "problem framing", "target extraction"),
        default_tasks=("idea_profile_extraction",),
    ),
    AgentProfile(
        agent_key="idea_researcher",
        display_name="Idea Researcher",
        provider="mock",
        role="idea_research",
        strengths=("evidence discovery", "pain signals", "competitor signals"),
        default_tasks=("idea_evidence_research",),
    ),
    AgentProfile(
        agent_key="idea_reviewer",
        display_name="Idea Reviewer",
        provider="openai",
        role="idea_review",
        strengths=("need analysis", "competition analysis", "monetization review"),
        default_tasks=("idea_review",),
    ),
    AgentProfile(
        agent_key="idea_scorer",
        display_name="Idea Scorer",
        provider="mock",
        role="idea_scoring",
        strengths=("opportunity scoring", "confidence scoring", "decision support"),
        default_tasks=("idea_opportunity_scoring",),
    ),
    AgentProfile(
        agent_key="idea_mvp_planner",
        display_name="Idea MVP Planner",
        provider="mock",
        role="idea_mvp_planning",
        strengths=("mvp scope", "do-not-build guardrails", "validation sequencing"),
        default_tasks=("mvp_generation",),
    ),
    AgentProfile(
        agent_key="idea_backlog_planner",
        display_name="Idea Backlog Planner",
        provider="mock",
        role="idea_backlog_planning",
        strengths=("idea backlog", "validation tasks", "pricing tasks"),
        default_tasks=("idea_backlog_generation",),
    ),
    AgentProfile(
        agent_key="idea_roadmap_planner",
        display_name="Idea Roadmap Planner",
        provider="mock",
        role="idea_roadmap_planning",
        strengths=("now next later", "validation roadmap", "beta sequencing"),
        default_tasks=("idea_roadmap_generation",),
    ),
    AgentProfile(
        agent_key="idea_monitoring",
        display_name="Idea Monitoring",
        provider="mock",
        role="idea_monitoring",
        strengths=("pain trend", "competitor trend", "search trend"),
        default_tasks=("idea_monitoring",),
    ),
    AgentProfile(
        agent_key="idea_discovery",
        display_name="Idea Discovery",
        provider="mock",
        role="idea_discovery",
        strengths=("opportunity discovery", "pain cluster mining", "gap discovery"),
        default_tasks=("idea_discovery",),
    ),
    AgentProfile(
        agent_key="idea_comparator",
        display_name="Idea Comparator",
        provider="mock",
        role="idea_comparison",
        strengths=("multi-idea comparison", "tradeoff reports", "evidence comparison"),
        default_tasks=("idea_comparison",),
    ),
    AgentProfile(
        agent_key="product_converter",
        display_name="Product Converter",
        provider="mock",
        role="product_conversion",
        strengths=("idea to product profile", "market context handoff", "review readiness"),
        default_tasks=("convert_idea_to_product",),
    ),
)
